...
Only reviewed rules vendored in `.semgrep.yml` block. Validation proves every rule against adversarial unsafe fixtures and proves representative safe code remains clean.
